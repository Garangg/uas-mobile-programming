...
class _EditFieldPageState extends State<EditFieldPage> {
  ...
  void initState() {
    ...
    _lengthController =
        TextEditingController(text: widget.field.length.toString());
    _widthController =
        TextEditingController(text: widget.field.width.toString());
  ...
  void _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        await FieldVM.updateField(updatedField).then((value) {
          showToast('Data lapangan berhasil diubah',
              context: context,
